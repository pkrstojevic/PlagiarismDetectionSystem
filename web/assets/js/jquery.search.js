...
;(function($) {
    ...
    $.extend($.searcher, {
        ...
        defaults : {
            ...
            // can be:
            // 1. highlight â€” highlight the whole element
            // 2. highlightSelected â€” highlight selected text of element
            // 3. replace â€” replace
            // 4. none â€” do nothing, usefull with afterSearch callback
